        ...
        <div id="navbar" className="navbar navbar-default ace-save-state">
            ...
            <div className="navbar-buttons navbar-header pull-right" role="navigation">
                ...
                <li className="grey dropdown-modal">
                    ...
                    <li className="dropdown-content">
                        ...
                        <li>
                            ...
                            <div className="progress progress-mini">
                                <div style={{width: '35%'}} className="progress-bar progress-bar-danger" />
                            </div>
                            </a>
                        </li>
                        <li>
                            ...
                            <div className="progress progress-mini">
                                <div style={{width: '15%'}} className="progress-bar progress-bar-warning" />
                            </div>
                            </a>
                        </li>
                        <li>
                            ...
                            <div className="progress progress-mini progress-striped active">
                                <div style={{width: '90%'}} className="progress-bar progress-bar-success" />
                            </div>
                            </a>
                        </li>
                        </ul>
                ...
                <li className="light-blue dropdown-modal">
                    ...
                    <img className="nav-user-photo" src="./assets/images/avatars/avatar5.png" alt="Jason's" />
